...
const Toast = ({ message, type = 'info', onClose, duration = 3000 }) => {
    ...
    return (
        <div
            className={`fixed top-20 right-4 z-[3000] flex items-center gap-3 px-5 py-4 rounded-xl border backdrop-blur-xl shadow-xl animate-[slideInRight_0.3s_ease-out] ${typeStyles[type]}`}
            role="alert"
        >
